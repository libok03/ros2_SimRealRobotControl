  ...
  public:
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "wheel_separation_multiplier")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Correction factor when the actual wheel separation differs from the nominal value in the wheel_separation parameter.";
          descriptor.read_only = false;
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "wheels_per_side") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.wheels_per_side = param.as_int();
