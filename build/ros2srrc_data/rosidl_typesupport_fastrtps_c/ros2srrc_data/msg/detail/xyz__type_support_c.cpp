...
#include "ros2srrc_data/msg/detail/xyz__rosidl_typesupport_fastrtps_c.h"
...
using _Xyz__ros_msg_type = ros2srrc_data__msg__Xyz;
...
static uint32_t _Xyz__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2srrc_data__msg__Xyz(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2srrc_data__msg__Xyz;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Xyz__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2srrc_data__msg__Xyz(
