...
#include "ros2srrc_data/msg/detail/joint__rosidl_typesupport_fastrtps_c.h"
...
using _Joint__ros_msg_type = ros2srrc_data__msg__Joint;
...
static uint32_t _Joint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2srrc_data__msg__Joint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2srrc_data__msg__Joint;
    is_plain =
      (
...
static size_t _Joint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2srrc_data__msg__Joint(
