...
#include "ros2srrc_data/msg/detail/xyzypr__rosidl_typesupport_fastrtps_c.h"
...
using _Xyzypr__ros_msg_type = ros2srrc_data__msg__Xyzypr;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Xyzypr__ros_msg_type * ros_message = static_cast<const _Xyzypr__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr << ros_message->x;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Xyzypr__ros_msg_type * ros_message = static_cast<_Xyzypr__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _Xyzypr__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2srrc_data__msg__Xyzypr(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2srrc_data__msg__Xyzypr;
    is_plain =
      (
...
static size_t _Xyzypr__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2srrc_data__msg__Xyzypr(
...
static message_type_support_callbacks_t __callbacks_Xyzypr = {
  "ros2srrc_data::msg",
  "Xyzypr",
...
static rosidl_message_type_support_t _Xyzypr__type_support = {
